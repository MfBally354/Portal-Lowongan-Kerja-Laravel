                    ...
                    <form action="{{ route('companies.update', $company) }}" method="POST" enctype="multipart/form-data">
                        ...
                        @if($company->logo)
                            <div class="mb-4">
                                ...
                                <img src="{{ asset('storage/' . $company->logo) }}" alt="{{ $company->name }}" class="w-24 h-24 rounded">
                            </div>
                        @endif
                        ...
                        <div class="mb-4">
                            <label for="logo" class="block text-sm font-medium text-gray-700">Change Logo</label>
